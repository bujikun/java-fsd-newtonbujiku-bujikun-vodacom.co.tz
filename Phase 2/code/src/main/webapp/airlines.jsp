    ...
    <div class="row mt-2 mb-3">
        ...
        <div class="col-md-8 col-lg-8 col-xl-8">
            <div class="d-flex flex-column justify-content-center align-items-center">
                ...
                <div class="d-block">
                    <a class="btn btn-outline-success btn-lg me-2" href="add-airline"><span class="material-icons-outlined" style="font-size: 1.5rem;">add_circle_outline</span>&nbsp;Add New Airline</a>
                </div>
